{* Modified to fix bug #006345 / #006346 / #006347 by tommy from cs-cart.jp 2016 *}
{* クレジットカード番号のバリデーションに関する不具合を修正 *}
{* http://forum.cs-cart.com/tracker/issue-6347-diners-club-card-number-not-recognised/?verfilter=123 *}
