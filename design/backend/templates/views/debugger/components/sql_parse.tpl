<div id="DebugToolbarSubTabSQLParse">
    <form action="{""|fn_url}" method="post" class="cm-ajax">
        ...
        <table width="100%" style="height:50px;">
            <tr>
                <td style="width: 100px; vertical-top: top;">{include file="buttons/button.tpl" but_text="Send" but_id="DebugToolbarSubTabSQLParseSubmit" id="DebugToolbarSubTabSQLParseSubmit" but_name="submit" but_role="submit" but_meta="btn-primary"}</td>
                <td valign="top">
