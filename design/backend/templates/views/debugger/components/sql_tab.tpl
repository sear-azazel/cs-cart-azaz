            ...
            {foreach from=$data.list item="query" key="key"}
                ...
                <tr>
                    ...
                    <td class="{if $color}{$color}{/if}"><a
                                ...
                                data-ca-target-id="DebugToolbarSubTabSQLParse" class="cm-ajax cm-ajax-cache">
    ...
    <div class="deb-sub-tab-content" id="DebugToolbarSubTabSQLParse">
        <form action="{""|fn_url}" method="post" class="cm-ajax" id="DebugToolbarSqlParce">
            ...
            <table width="100%">
                ...
                <tr>
                    <td style="width: 100px; padding-top: 10px;">{include file="buttons/button.tpl" but_text="Send" but_id="DebugToolbarSubTabSQLParseSubmit" id="DebugToolbarSubTabSQLParseSubmit" but_name="submit" but_role="submit" but_meta="btn-primary"}</td>
                    <td valign="middle">
