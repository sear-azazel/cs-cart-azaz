...
<div class="cm-tabs-content" id="tabs_content">
    <div id="content_tab_general">
        ...
        <fieldset>
            ...
            <div class="control-group">
                <label class="control-label" for="tracking_number">{if $order_info.pay_by_kuroneko == 'Y'}{__("jp_kuroneko_webcollect_slip_no")}{else}{__("tracking_number")}{/if}</label>
                <div class="controls">
                ...
                <div class="control-group select-field krnkwc-send-slip-no">
                    <div class="controls">
                        <label for="krnkwc_send_slip_no" class="checkbox">
                            <input type="checkbox" name="shipment_data[send_slip_no]" id="krnkwc_send_slip_no" value="Y"  checked />
