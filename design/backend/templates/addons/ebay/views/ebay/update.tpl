            ...
            {capture name="buttons"}
                {if $id}
                    {capture name="tools_list"}
                        ...
                        <li>{btn type="list" text=__("ebay_end_template_on_ebay") class="cm-ajax cm-comet cm-post" href="ebay.end_template?template_id=`$id`&redirect_url=`$return_current_url`"}</li>
                        <li>{btn type="list" text=__("ebay_sync_products_status") class="cm-ajax cm-comet cm-post" href="ebay.update_template_product_status?template_id=`$id`&redirect_url=`$return_current_url`"}</li>
                        <li class="divider"></li>
                    ...
                    {btn type="text" text=__("export_products_to_ebay") class="btn btn-success cm-ajax cm-comet cm-post" href="ebay.export_template?template_id=`$id`&redirect_url=`$return_current_url`"}
                {/if}
