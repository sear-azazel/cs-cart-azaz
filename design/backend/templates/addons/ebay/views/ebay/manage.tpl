    ...
    <td class="nowrap right">
        <div class="hidden-tools">
            {capture name="tools_items"}
                <li>{btn type="list" class="cm-ajax cm-comet cm-post" text=__("export_products_to_ebay") href="ebay.export_template?template_id=`$template.template_id`"}</li>
                <li>{btn type="list" class="cm-ajax cm-comet cm-post" text=__("ebay_end_template_on_ebay") href="ebay.end_template?template_id=`$template.template_id`"}</li>
                <li>{btn type="list" class="cm-ajax cm-comet cm-post" text=__("ebay_sync_products_status") href="ebay.update_template_product_status?template_id=`$template.template_id`"}</li>
                ...
                <li>{btn type="list" class="cm-confirm cm-post" data=["data-ca-confirm-text" => "{__("category_deletion_side_effects")}"] text=__("delete") href="ebay.delete_template?template_id=`$template.template_id`"}</li>
            {/capture}
