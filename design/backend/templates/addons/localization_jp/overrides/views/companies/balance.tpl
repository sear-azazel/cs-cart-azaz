...
<tr>
    ...
    <th><a class="cm-ajax" href="{"`$c_url`&sort_by=sort_amount&sort_order=`$search.sort_order_rev`"|fn_url}" data-ca-target-id="pagination_contents">{if $smarty.const.CART_LANGUAGE == 'ja'}{__("amount")}{else}{__("payment_amount")}{/if}{if $search.sort_by == "sort_amount"}{$c_icon nofilter}{else}{$c_dummy nofilter}{/if}</a></th>
    ...
    <th>{if $smarty.const.CART_LANGUAGE == 'ja'}{__("orders")}{else}{__("payment")}{/if}</th>
