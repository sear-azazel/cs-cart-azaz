...
{if !$id}
    {include file="views/profiles/components/profile_fields.tpl" section="B" title=__("jp_company_address") shipping_flag=false}
{else}
...
<div class="control-group">
    <label for="elm_company_address" class="control-label cm-required">{__("jp_address_vendors")}:</label>
    <div class="controls">
