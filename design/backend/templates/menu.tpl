        ...
        {if "ULTIMATE"|fn_allowed_for}
            ...
            <div class="nav-ult">
                ...
                {if !$runtime.company_data.company_id}
                    {assign var="name" value=__("all_vendors")|fn_lcjp_mve_convert_lang_var:top_company_id}
                {/if}
            ...
            <ul class="nav">
                ...
                {else}
                    {if fn_check_view_permissions("companies.get_companies_list", "GET")}
                        ...
                        {include file="common/ajax_select_object.tpl" data_url="companies.get_companies_list?show_all=Y&action=href" text=$company_name|fn_lcjp_mve_convert_lang_var:top_company_id id="top_company_id" type="list" extra_content=$smarty.capture.extra_content}
                    {else}
                        <li class="dropdown">
