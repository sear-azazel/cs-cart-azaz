...
////////////////////////////////////////////////////////////////////////////////////////
// 決済依頼接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAARA0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAARA0010APIAction_execute.action');

// 決済結果照会接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAARS0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAARS0010APIAction_execute.action');

// 決済取消依頼接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAACL0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAACL0010APIAction_execute.action');

// 出荷情報依頼接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAASL0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAASL0010APIAction_execute.action');

// 取引状況照会接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAAST0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAAST0010APIAction_execute.action');

// 請求書印字情報取得接続先URL（テスト環境）
define('KRNKWC_TEST_URL_KAASD0010', 'http://demo.yamato-credit-finance.jp/kuroneko-atobarai-api/KAASD0010APIAction_execute.action');
////////////////////////////////////////////////////////////////////////////////////////
