...
if( empty($_edit_mail_tpl) ) {
	...
	// ユーザーグループに関するデータ
	$tpl_usergroup_id = $tpl_base_data['usergroup_id']->value;
	$tpl_usergroup_data = $tpl_base_data['usergroups']->value[$tpl_usergroup_id];
	...
	array(
		...
		'U_USERGROUPS' => 
				array('desc' => 'usergroup', 
						'value' => empty($_edit_mail_tpl) ? $tpl_usergroup_data['usergroup'] : ''),
	);
