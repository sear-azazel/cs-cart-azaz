...
if( !empty($tpl_products_data) ){
	...
	if( !empty($tpl_products_data) ){
		...
		foreach( $tpl_products_data as $tpl_product_data ){
			...
			$tpl_supplier_products_blk .= fn_url("products.update?product_id=$supplier_product_id", 'V', 'http');
...
fn_set_hook('mail_tpl_var_addons_vendor_data_premoderation_notification', $mail_tpl_var, $tpl_company_data, $tpl_products_data, $tpl_base_status, $mail_template);
/////////////////////////////////////////////////////////////////////////////
