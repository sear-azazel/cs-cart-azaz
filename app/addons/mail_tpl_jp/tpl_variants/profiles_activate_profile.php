...
if( empty($_edit_mail_tpl) ) {
	...
	// 一般設定に関するデータ
	$tpl_general_settngs = $tpl_base_data['settings']->value['General'];
	...
	array(
		...
		'URL' => 
				array('desc' => 'mtpl_activation_url', 
						'value' => empty($_edit_mail_tpl) ? $tpl_config['http_location'] . '/' . $tpl_config['admin_index'] . "?dispatch=profiles.update&user_id=" . $tpl_user_data['user_id'] : ''),
	);
