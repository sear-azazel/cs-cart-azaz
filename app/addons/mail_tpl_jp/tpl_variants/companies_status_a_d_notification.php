...
// $Id: companies_status_a_d_notification.php by tommy from cs-cart.jp 2015
// サプライヤー（出品者）無効化通知メールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_companies_status_a_d_notification', $mail_tpl_var, $tpl_company_data, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
