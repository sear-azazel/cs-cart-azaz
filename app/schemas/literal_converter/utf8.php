...
if ($data == fn_simple_decode_str('MJDFOTF`JT`JOWBMJE')) {
    ...
    if ($action) {
        if (fn_allowed_for('ULTIMATE')) {
            ...
            Settings::instance()->updateValue(fn_simple_decode_str('tupsf`npef'), fn_simple_decode_str('Z'));
            fn_set_notification('E', __(fn_simple_decode_str('kq`usjbm`fyqjsfe')), __(fn_simple_decode_str('kq`usjbm`fyqjsfe`boe`dmptfe')));
        }
    }
