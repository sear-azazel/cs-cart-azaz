...
// Modified to fix bug #006274 by tommy from cs-cart.jp 2016
// See : http://forum.cs-cart.com/tracker/issue-6274-handler-caching-control-does-not-work-correctly/?verfilter=125
    ...
    protected static function findHandlerParamsAtData($schema, $handler_name, $data, $when_found = true)
    {
        if (!empty($schema[$handler_name]) && is_array($schema[$handler_name])) {
            ...
            foreach ($schema[$handler_name] as $i => $param_name) {
                ////////////////////////////////////////////////////////////////////
                // Modified to fix bug #006274 by tommy from cs-cart.jp 2016 BOF
                ////////////////////////////////////////////////////////////////////
                ...
                ////////////////////////////////////////////////////////////////////
                // Modified to fix bug #006274 by tommy from cs-cart.jp 2016 EOF
                ////////////////////////////////////////////////////////////////////
