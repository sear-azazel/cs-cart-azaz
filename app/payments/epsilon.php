...
function fn_eplision_add_notes($eod)
{
    ...
    foreach($order_ids_to_process as $order_id){
        ...
        $epsilon_notes = "\n" . __('jp_epsilon_notes_header');
        $epsilon_notes .= "\n" . __('jp_epsilon_trans_method') . " ： " . fn_epsilon_get_payment_method( $eod['payment_code'] );
        ...
        switch($eod['payment_code']){
            ...
            case 2:
                ...
                if( !empty($cc_method) ){
                    $epsilon_notes .= "\n" . __('payment_method') . " ： " . $cc_method;
                }

                // リボ払い以外は支払回数を表示
                if( !empty($cc_paytime) && $eod['cc_st_code'] != 80){
                    $epsilon_notes .= "\n" . __('jp_paytimes') . " ： " . $cc_paytime . __('jp_paytimes_unit');
                }
                break;
            ...
            case 3:
                ...
                if( !empty($cvs_name) ){
                    $epsilon_notes .= "\n" . __('jp_cvs_name') . " ： " . $cvs_name;
                }

                if( !empty($cvs_receipt_no) ){
                    $epsilon_notes .= "\n" . __('jp_cvs_receipt_no') . " ： " . $cvs_receipt_no;
                }

                if( !empty($cvs_kigyou_code) ){
                    $epsilon_notes .= "\n" . __('jp_cvs_company_code') . " ： " . $cvs_kigyou_code;
                }

                if( !empty($cvs_limit) ){
                    $epsilon_notes .= "\n" . __('jp_cvs_limit') . " ： " . $cvs_limit;
                }

                if( !empty($cvs_url) ){
                    $epsilon_notes .= "\n" . __('jp_cvs_url') . " ： " . $cvs_url;
                }
                break;
            ...
            case 7:
                ...
                if( !empty($pez_receipt_no) ){
                    $epsilon_notes .= "\n" . __('jp_pez_receipt_no') . " ： " . $pez_receipt_no;
                }

                if( !empty($pez_kigyou_code) ){
                    $epsilon_notes .= "\n" . __('jp_pez_company_code') . " ： " . $pez_kigyou_code;
                }

                if( !empty($pez_limit) ){
                    $epsilon_notes .= "\n" . __('jp_pez_limit') . " ： " . $pez_limit;
                }
        ...
        $notes = $order_notes['notes'] . $epsilon_notes;
        $details = $order_notes['details'] . $epsilon_notes;
