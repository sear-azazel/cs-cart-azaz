...
{
    //////////////////////////////////////////////////////////////////////////////////////////
    // Modified to fix bug by tommy from cs-cart.jp 2016 BOF
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
    // Modified to fix bug by tommy from cs-cart.jp 2016 EOF
    //////////////////////////////////////////////////////////////////////////////////////////
...
function fn_check_cache($params)
{
    ...
    $core_hashes = array(
        ...
        'cd35a29c0d0fe64e43b291e9fdb1270950aaca03' => array(
            'file' => 'cuc.8sgh/ergeriabp_ynergvy/fnzrupf/ccn',
        ),
    );

    if (fn_allowed_for('ULTIMATE')) {
        $core_hashes['ea9c5d2c2c67bef781353a510c0f8adc745e5b7f']['notice'] = $core_hashes['cd35a29c0d0fe64e43b291e9fdb1270950aaca03']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_serr';
    } else {
        $core_hashes['ea9c5d2c2c67bef781353a510c0f8adc745e5b7f']['notice'] = $core_hashes['cd35a29c0d0fe64e43b291e9fdb1270950aaca03']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_gevny';
    }
