...
// Modified to fix bug #006345 / #006346 / #006347 by tommy from cs-cart.jp 2016 BOF
// クレジットカード番号のバリデーションに関する不具合を修正
// See : http://forum.cs-cart.com/tracker/issue-6347-diners-club-card-number-not-recognised/?verfilter=123
        ...
        if (!empty($order)) {
            ...
            foreach ($order['products'] as $k => $v) {
                ...
                if ($get_edp_files == true && $order['products'][$k]['extra']['is_edp'] == 'Y') {
                    ...
                    ///////////////////////////////////////////////////////////////////
                    fn_set_hook('jp_get_edp_info_post', $order, $order_id, $lang_code, $k, $v);
                    ///////////////////////////////////////////////////////////////////
...
function fn_change_order_status($order_id, $status_to, $status_from = '', $force_notification = array(), $place_order = false)
{
    ...
    // オプション別ダウンロードファイル設定用フックを設定
    ///////////////////////////////////////////////////////////////////
    fn_set_hook ('jp_order_notification_pre', $edp_data, $order_info);
    ///////////////////////////////////////////////////////////////////
    // Modified for Japanese version by ari from cs-cart.jp 2016 EOF
    ///////////////////////////////////////////////////////////////////
        ...
        if (!empty($v['extra']['is_edp']) && $v['extra']['is_edp'] == 'Y') {
            ...
            foreach ($activations as $file_id => $activation_type) {
                ...
                if (!empty($edp_data[$v['product_id']]['files'][$file_id])) {
                    ...
                    // オプション別ダウンロードファイル設定用フックを設定
                    ///////////////////////////////////////////////////////////////////
                    fn_set_hook('jp_get_edp_file_info_post', $edp_data, $v, $file_id);
                    ///////////////////////////////////////////////////////////////////
                    // Modified for Japanese version by ari from cs-cart.jp 2016 EOF
                    ///////////////////////////////////////////////////////////////////
                }
...
function fn_update_shipment($shipment_data, $shipment_id = 0, $group_key = 0, $all_products = false, $force_notification = array())
{
    ...
    if (!empty($shipment_id)) {
        ...
        // 追跡情報更新時に動作するフックポイントを設定
        /////////////////////////////////////////////////////////////////////
        fn_set_hook('jp_update_shipment', $shipment_id, $shipment_data, $group_key, $all_products);
        /////////////////////////////////////////////////////////////////////
...
function fn_get_credit_card_type($number)
{
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    // Modified to fix bug #006345 / #006346 / #006347 by tommy from cs-cart.jp 2016 EOF
    //////////////////////////////////////////////////////////////////////////////////////
