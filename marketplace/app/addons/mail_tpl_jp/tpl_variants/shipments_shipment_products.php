...
$mail_tpl_var = 
	array(
		...
		'CARRIER' =>
				array('desc' => 'carrier',
						'value' => empty($_edit_mail_tpl) ? fn_mtpl_get_carrier_name($tpl_shipment['carrier'], $tpl_order_info['lang_code']) : ''),
		'TRACK_NO' =>
				array('desc' => 'tracking_number',
						'value' => empty($_edit_mail_tpl) ? $tpl_shipment['tracking_number'] : ''),
		'TRACK_URL' =>
				array('desc' => 'jp_shipment_tracking_url',
						'value' => empty($_edit_mail_tpl) ? fn_mtpl_get_shipment_tracking_url($tpl_shipment['carrier'], $tpl_shipment['tracking_number']) : ''),
		'P_BLK' =>
				array('desc' => 'products',
						'value' => empty($_edit_mail_tpl) ? fn_mtpl_get_shipped_products($tpl_order_info['products'], $tpl_shipment['items'], $tpl_base_data) : ''),
		'COMMENTS' =>
				array('desc' => 'comments',
