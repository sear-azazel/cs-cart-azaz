...
class TwigmoConnector extends \AbstractTwigmoConnector
{
    ...
    public function authPage($page)
    {
        ...
        // バージョン情報に "_JP_" 以下を含めない
        ////////////////////////////////////////////////////////////////////
        fn_redirect($url, true, Registry::get('twg_jp_main_ver') == '4.0.1');  // $allow_external_redirect is the third param in 4.0.1
        ////////////////////////////////////////////////////////////////////
    ...
    public function connectAdmin($user_data, $is_reconnect = false)
    {
        ...
        $data = array(
            ...
            // バージョン情報に "_JP_" 以下を含めない
            ////////////////////////////////////////////////////////////////////
            'engine_version' => Registry::get('twg_jp_main_ver'),
            ////////////////////////////////////////////////////////////////////
            // Modified for Japanese version by tommy from cs-cart.jp 2016 EOF
            ////////////////////////////////////////////////////////////////////
    ...
    public static function checkUpdates()
    {
        ...
        // バージョン情報に "_JP_" 以下を含めない
        ////////////////////////////////////////////////////////////////////
        $url .= '?store_version=' . Registry::get('twg_jp_main_ver') . '&twigmo_version=' . TWIGMO_VERSION;
        ////////////////////////////////////////////////////////////////////
        // Modified for Japanese version by tommy from cs-cart.jp 2016 EOF
        ////////////////////////////////////////////////////////////////////
