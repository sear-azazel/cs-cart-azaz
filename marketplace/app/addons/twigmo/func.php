...
function fn_twigmo_before_dispatch() // Hook
{
    ...
    ////////////////////////////////////////////////////////////////////
    $jp_version_arr = explode('_JP_', PRODUCT_VERSION);
    Registry::set('twg_jp_main_ver', $jp_version_arr[0]);
    ////////////////////////////////////////////////////////////////////
...
function fn_twg_get_banner_url($banner_id, $url)
{
    if (Registry::get('addons.statistics.status') == 'A') {
        ////////////////////////////////////////////////////////////////////
        // Modified for Japanese version by tommy from cs-cart.jp 2016 BOF
        // バージョン判定に "_JP_" 以下を含めない
        ////////////////////////////////////////////////////////////////////
        if (version_compare(Registry::get('twg_jp_main_ver'), '4.1.1', '<')) {
...
function fn_twg_get_all_settings()
{
    ...
    // バージョン判定に "_JP_" 以下を含めない
    ////////////////////////////////////////////////////////////////////
    if (version_compare(Registry::get('twg_jp_main_ver'), '4.0.2', '>=')) {
