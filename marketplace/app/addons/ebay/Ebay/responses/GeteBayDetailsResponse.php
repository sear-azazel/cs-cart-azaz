    ...
    public function __construct(\SimpleXMLElement $response)
    {
        ...
        if (!empty($response->ShippingLocationDetails)) {
            ...
            foreach ($response->ShippingLocationDetails as $item) {
                $this->shipping_location_details[(string) $item->ShippingLocation] = array(
                    'code' => XmlHelper::getAsString($item, 'ShippingLocation'),
                    'name' => XmlHelper::getAsString($item, 'Description'),
                    'time' => XmlHelper::getAsString($item, 'UpdateTime'),
                );
            }
        }
    }
