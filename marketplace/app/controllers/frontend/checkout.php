...
// Modified to fix bug #006246 by tommy from cs-cart.jp 2016
// See : http://forum.cs-cart.com/tracker/issue-6246-shipping-estimator-changes-shipping-address-in-checkout/?verfilter=125&catfilter=3
// Modified by tommy from cs-cart.jp 2016
// エラーメッセージが正しく表示されないバグを修正
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($mode == 'add_profile') {
        ...
        if (list($user_id, $profile_id) = fn_update_user(0, $_REQUEST['user_data'], $auth, false, true)) {
            ...
            ///////////////////////////////////////////////////////////////
            fn_set_hook('jp_checkout_add_profile_post', $step, $profile_fields);
            ///////////////////////////////////////////////////////////////
