...
if ($mode == 'print_invoice') {
    if (!empty($_REQUEST['order_id'])) {
        ...
        // お客様が注文時に選択した言語で注文確認書を出力
        ///////////////////////////////////////////////////////////////
        $order_info = fn_get_order_info($_REQUEST['order_id']);
        fn_print_order_invoices($_REQUEST['order_id'], !empty($_REQUEST['format']) && $_REQUEST['format'] == 'pdf', AREA, $order_info['lang_code']);
        ///////////////////////////////////////////////////////////////
    ...
    if (!empty($_REQUEST['order_id'])) {
        ///////////////////////////////////////////////////////////////
        // Modified for Japanese Ver by tommy from cs-cart.jp 2016 BOF
        // お客様が注文時に選択した言語で配送表を出力
        ///////////////////////////////////////////////////////////////
        $order_info = fn_get_order_info($_REQUEST['order_id']);
        fn_print_order_packing_slips($_REQUEST['order_id'], !empty($_REQUEST['format']) && $_REQUEST['format'] == 'pdf', $order_info['lang_code']);
        ///////////////////////////////////////////////////////////////
        // Modified for Japanese Ver by tommy from cs-cart.jp 2016 EOF
        ///////////////////////////////////////////////////////////////
    }
