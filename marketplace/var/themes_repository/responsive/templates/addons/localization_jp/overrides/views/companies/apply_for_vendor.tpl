    ...
    <div id="apply_for_vendor_account" >
        ...
        <form action="{"companies.apply_for_vendor"|fn_url}" method="post" name="apply_for_vendor_form">
            ...
            <div class="ty-control-group shipping-zip-code">
                ...
                <input type="text" name="company_data[zipcode]" id="company_address_zipcode" size="32" value="{$company_data.zipcode}" class="ty-input-text" onKeyUp="AjaxZip3.zip2addr(this,'','company_data[state]','company_data[city]','','company_data[address]');" />
            </div>
