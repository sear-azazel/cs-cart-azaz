    ...
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00001]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00001]" id="convenience_00001" value="true" {if $processor_params.convenience['00001'] == "true"} checked="checked"{/if} /> {__("jp_cvs_ls")}
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00002]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00002]" id="convenience_00002" value="true" {if $processor_params.convenience['00002'] == "true"} checked="checked"{/if} /> {__("jp_cvs_fm")}
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00005]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00005]" id="convenience_00005" value="true" {if $processor_params.convenience['00005'] == "true"} checked="checked"{/if} /> {__("jp_cvs_ms")}
                <br />
                ...
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00003]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00003]" id="convenience_00003" value="true" {if $processor_params.convenience['00003'] == "true"} checked="checked"{/if} /> {__("jp_cvs_ts")}
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00004]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00004]" id="convenience_00004" value="true" {if $processor_params.convenience['00004'] == "true"} checked="checked"{/if} /> {__("jp_cvs_ck")}
                <br />
                ...
                <br />
                <input type="hidden" name="payment_data[processor_params][convenience][00008]" value="false" />
                <input type="checkbox" name="payment_data[processor_params][convenience][00008]" id="convenience_00008" value="true" {if $processor_params.convenience['00008'] == "true"} checked="checked"{/if} /> {__("jp_cvs_sm")}
            </div>
        </div>
        <div class="control-group">
