...
{if $smarty.const.CART_LANGUAGE == 'ja'}
    {assign var="title_inventory" value=__("combination")}
{else}
    {assign var="title_inventory" value=__("inventory")}
{/if}
{include file="common/mainbox.tpl" title=$title_inventory content=$smarty.capture.mainbox adv_buttons=$smarty.capture.adv_buttons buttons=$smarty.capture.buttons}