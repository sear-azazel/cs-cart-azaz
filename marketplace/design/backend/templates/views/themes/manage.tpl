...
<div class="span8 theme-description" id="theme_description_container">
                ...
                {foreach $theme.layouts as $available_layout}
                    <tr>
                        ...
                        <td class="right btn-toolbar">
                            ...
                            {/if}
                            {include file="buttons/button.tpl" but_href="customization.update_mode?type=theme_editor&status=enable&s_layout=`$available_layout.layout_id`" but_text=__("theme_editor") but_role="action" but_meta=$is_default but_target="_blank"}
    ...
    {else}
        <div class="theme-no-styles">
            ...
            {include file="buttons/button.tpl" but_href="customization.update_mode?type=theme_editor&status=enable" but_text=__("theme_editor") but_role="action" but_meta="btn-primary cm-post"}
        </div>
    {/if}
    {/hook}
